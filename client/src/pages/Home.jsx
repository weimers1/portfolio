    ...
    return (
        ...
        >
            <div className="grid grid-cols-1">
                <section className="flex flex-col place-items-center pt-10 lg:pt-0 lg:pb-10">
                    <img
                ...
                <section className="hidden lg:block flex flex-col justify-center pt-2 text-4xl">
                ...
                <section
                    className={
                        ...
                        ' grid grid-cols-1 lg:grid-cols-3 flex flex-col place-items-center'
                    }
                >
                ...
                <section className="pt-10 mt-10 flex flex-col place-items-center">
