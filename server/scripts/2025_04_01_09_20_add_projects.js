...
async function addProjects() {
    try {
        ...
        const projectData = [
            ...
            {
                titleProject: 'Devs Connect',
                titleRepo: 'devs-connect',
                description: 'A web development community connection platform.',
                urlWebsite: 'https://github.com/weimers1/devs-connect',
                filePathLogo: '/src/assets/images/default.svg',
                filePathViews: '/src/assets/images/default.svg',
                tasks: [
                    'Architect and develop a scalable MERN-stack community platform with React frontend, Node.js/Express backend, and MySQL database, leveraging AWS S3 for profile image storage and Docker for containerized deployment, enhancing user engagement for 10,000+ potential developers',
